...
public class MultiLineToolbarPref extends DefaultTabPreferenceSetting {
  ...
  public void addGui(PreferenceTabbedPane gui) {
    ...
    panel.add(indicatorEnabled, gbc.insets(20, 2, 0, 0).grid(0, 1));
    panel.add(size, gbc.insets(45, 2, 0, 0).grid(0, 2).span(1).fill(GBC.NONE).anchor(GBC.CENTER));
    panel.add(indicatorSize, gbc.insets(5, 2, 0, 0).grid(1, 2));
    panel.add(link, gbc.insets(45, 2, 0, 0).grid(0, 3).span(3).fill(GBC.HORIZONTAL).anchor(GBC.WEST));
    panel.add(Box.createVerticalGlue(), GBC.eol().grid(0, 4).fill(GBC.BOTH));
