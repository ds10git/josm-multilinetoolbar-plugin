...
public class MultiLineToolbarPref extends DefaultTabPreferenceSetting {
  ...
  public static final String KEY_LINE_SEPARATOR = KEY_BASE+".lineSeparator";
  ...
  private JCheckBox lineSeparator;
  ...
  public void addGui(PreferenceTabbedPane gui) {
    ...
    lineSeparator = new JCheckBox(tr("Show line separator"), Config.getPref().getBoolean(KEY_LINE_SEPARATOR, true));
    ...
    enabled.addItemListener(e -> {
      ...
      lineSeparator.setEnabled(buttonsCompact.isEnabled());
      indicatorEnabled.setEnabled(buttonsCompact.isEnabled());
      indicatorSize.setEnabled(buttonsCompact.isEnabled() && indicatorEnabled.isSelected());
    ...
    lineSeparator.setEnabled(enabled.isSelected());
    ...
    panel.add(lineSeparator, gbc.grid(0, 1));
    panel.add(buttonsCompact, gbc.grid(0, 2));
    panel.add(indicatorEnabled, gbc.insets(20, 2, 0, 0).grid(0, 3));
    panel.add(size, gbc.insets(45, 2, 0, 0).grid(0, 4).span(1).fill(GBC.NONE).anchor(GBC.CENTER));
    panel.add(indicatorSize, gbc.insets(5, 2, 0, 0).grid(1, 4));
    panel.add(link, gbc.insets(45, 2, 0, 0).grid(0, 5).span(3).fill(GBC.HORIZONTAL).anchor(GBC.WEST));
    panel.add(Box.createVerticalGlue(), GBC.eol().grid(0, 6).fill(GBC.BOTH));
  ...
  public boolean ok() {
    ...
    Config.getPref().putBoolean(KEY_LINE_SEPARATOR, lineSeparator.isSelected());
